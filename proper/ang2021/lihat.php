...
<body>
    ...
    <div class="menu-5">
        <ul>
            <li class="current"><a href="#ang" data-hover="Anggaran dan Kinerja 2021">Anggaran dan Kinerja 2021</a></li>
    ...
    <h2 id="ang">Rincian Program, Kegiatan, Sub Kegiatan, Anggaran dan Kinerja Badan <br> Kesatuan Bangsa dan Politik Tahun 2021.</h2>
<div class="create">
