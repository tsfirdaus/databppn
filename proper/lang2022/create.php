...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql="INSERT INTO langkah_2022 VALUES ('','$program','$kegiatan','$sub_kegiatan','$target','$realisasi','$keterangan','$langkah2');";
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        ...
        <div class="form-group">
            <label>Langkah-Langkah : <br></label>
            <input type="text" name="langkah2" class="form-control" placeholder="Masukkan Langkah-Langkah"/>
        </div>
